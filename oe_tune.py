...
if args.dataset == 'cifar10':
    train_data_in = dset.CIFAR10('/nobackup/users/jk_lee/outlier/outlier-exposure-master/datasets/cifar', train=True, transform=train_transform)
    ...
    train_data_in = dset.CIFAR100('/nobackup/users/jk_lee/outlier/outlier-exposure-master/datasets/cifar', train=True, transform=train_transform)
