...
if 'cifar10_' in args.method_name:
    train_data = dset.CIFAR10('/nobackup/users/jk_lee/outlier/outlier-exposure-master/datasets/cifar', train=True, transform=test_transform)
    ...
    train_data = dset.CIFAR100('/nobackup/users/jk_lee/outlier/outlier-exposure-master/datasets/cifar', train=True, transform=test_transform)
